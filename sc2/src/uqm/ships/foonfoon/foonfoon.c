...
{
#define FOONFOON_REAR_OFFSET (20 << RESOLUTION_FACTOR) // JMS_GFX
...
#define DISCRIMINATOR_OFFSET (4 << RESOLUTION_FACTOR) // JMS_GFX
	...
	ButtMissileBlock.pixoffs = FOONFOON_REAR_OFFSET;
...
static void
foonfoon_intelligence (ELEMENT *ShipPtr, EVALUATE_DESC *ObjectsOfConcern,
...
#define MISSILE_OFFSET (1 << RESOLUTION_FACTOR) // JMS_GFX
	...
	MissileBlock.pixoffs = FOONFOON_FORWARD_OFFSET;
...
init_foonfoon (void)
{
	...
	if (RESOLUTION_FACTOR == 0)
	{
		...
		foonfoon_desc.init_weapon_func = initialize_standard_missile;
	...
	else if (RESOLUTION_FACTOR == 1)
	{
		...
		foonfoon_desc_2xres.init_weapon_func = initialize_standard_missile;
	...
	else
	{
		...
		foonfoon_desc_4xres.init_weapon_func = initialize_standard_missile;
