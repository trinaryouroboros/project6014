...
#define MODE_INFO_HEIGHT ((STATUS_HEIGHT - 3 * RESOLUTION_FACTOR) - MODE_INFO_ORIGIN_Y)
#define RACE_INFO_ORIGIN_Y (SHIP_INFO_HEIGHT + 6 * RESOLUTION_FACTOR) // JMS_GFX
#define RACE_INFO_HEIGHT ((STATUS_HEIGHT - 3 * RESOLUTION_FACTOR) - RACE_INFO_ORIGIN_Y)
