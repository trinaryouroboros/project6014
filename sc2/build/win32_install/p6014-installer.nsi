...
!define MUI_WELCOMEFINISHPAGE_BITMAP "starbase.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_BITMAP "kohrah.bmp"
...
OutFile "P6014_v${PRODUCT_VERSION}_win_installer.exe"
...
;      CopyFiles "$INSTDIR\content\packages\p6014-0.5.0-3domusic.uqm" "$INSTDIR\content\packages\p6014-0.6.0-3domusic.uqm"
;DelOldContent:
...
Section -ShortcutsAndIcons
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\p6014 (Safe Mode).lnk" "$INSTDIR\p6014.exe" "-wx -r 640x480 -c none --sound=none -g 1.0 -M 100 -S 100 -T 100 -q medium"
    CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\p6014 (Safe OpenGL).lnk" "$INSTDIR\p6014.exe" "-wo -r 640x480 -c none --sound=none -g 1.0 -M 100 -S 100 -T 100 -q medium"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\p6014.exe"
...
;  Delete "$SMPROGRAMS\$ICONS_GROUP\Keyboard Test.lnk"
  ...
  Delete "$DESKTOP\The Ur-Quan Masters p6014.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\The Ur-Quan Masters p6014.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\p6014 (Safe Mode).lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\p6014 (Safe OpenGL).lnk"
