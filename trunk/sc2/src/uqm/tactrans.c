...
cycle_ion_trail (ELEMENT *ElementPtr)
{
	...
	{
		BUILD_COLOR (MAKE_RGB15_INIT (0x0F, 0x0F, 0x00), 0x7a),
		BUILD_COLOR (MAKE_RGB15_INIT (0x0E, 0x0E, 0x00), 0x7b),
		BUILD_COLOR (MAKE_RGB15_INIT (0x0C, 0x0C, 0x00), 0x7c),
		BUILD_COLOR (MAKE_RGB15_INIT (0x0A, 0x0A, 0x00), 0x7d),
		BUILD_COLOR (MAKE_RGB15_INIT (0x07, 0x07, 0x00), 0x7e),
		BUILD_COLOR (MAKE_RGB15_INIT (0x03, 0x03, 0x00), 0x7f),
		BUILD_COLOR (MAKE_RGB15_INIT (0x1F, 0x1F, 0x00), 0x2a),
		BUILD_COLOR (MAKE_RGB15_INIT (0x1B, 0x1B, 0x00), 0x2b),
		BUILD_COLOR (MAKE_RGB15_INIT (0x17, 0x17, 0x00), 0x2c),
		BUILD_COLOR (MAKE_RGB15_INIT (0x15, 0x15, 0x00), 0x2d),
		BUILD_COLOR (MAKE_RGB15_INIT (0x13, 0x13, 0x00), 0x2e),
		BUILD_COLOR (MAKE_RGB15_INIT (0x11, 0x11, 0x00), 0x2f),
	};
