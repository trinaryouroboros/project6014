...
static RACE_DESC isd_desc =
{
	...
	},
	{
		...
		{
			ISD_FUSION_BIG_MASK_PMAP_ANIM,
			ISD_FUSION_MED_MASK_PMAP_ANIM,
			ISD_FUSION_SML_MASK_PMAP_ANIM,
		},
		{
			ISD_FIGHTER_BIG_MASK_PMAP_ANIM,
			ISD_FIGHTER_MED_MASK_PMAP_ANIM,
			ISD_FIGHTER_SML_MASK_PMAP_ANIM,
		},
		{
