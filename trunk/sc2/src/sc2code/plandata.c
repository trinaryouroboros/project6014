...
{{9044, 228}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 1, 132},
...
{{9246, 368}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 2, 139},
...
{{8560, 707}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 4, 132},
...
{{8844, 790}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 3, 132},
...
{{6882, 989}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 9, 137},
{{1233, 997}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 13, 43},
{{1338,1043}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 1, 43},
...
{{1279,1132}, MAKE_STAR (SUPER_GIANT_STAR, ORANGE_BODY, -1), MELNORME5_DEFINED, 3, 43},
...
{{6915,1174}, MAKE_STAR (SUPER_GIANT_STAR, GREEN_BODY, -1), MELNORME6_DEFINED, 5, 137},
...
{{6966,1231}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 4, 137},
...
{{9714,1317}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 1, 68},
{{2667,1321}, MAKE_STAR (SUPER_GIANT_STAR, ORANGE_BODY, -1), MELNORME7_DEFINED, 4, 31},
{{6912,1326}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 1, 137},
{{6496,1363}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 1, 137},
...
{{6358,1399}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 3, 137},
{{4630,1410}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 2, 42},
{{9880,1422}, MAKE_STAR (GIANT_STAR, GREEN_BODY, -1), 0, 4, 68},
...
{{6780,1469}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 3, 137},
{{2942,1489}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 2, 111},
{{4570,1490}, MAKE_STAR (GIANT_STAR, WHITE_BODY, -1), 0, 3, 42},
{{6949,1517}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 2, 137},
{{6470,1522}, MAKE_STAR (DWARF_STAR, WHITE_BODY, -1), 0, 2, 137},
{{5669,1539}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 4, 19},
{{4670,1570}, MAKE_STAR (GIANT_STAR, GREEN_BODY, -1), 0, 1, 42},
{{4800,1580}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 7, 42},
{{2750,1610}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 1, 31},
{{6741,1665}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 6, 137},
{{6450,1684}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 8, 137},
{{4740,1700}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 6, 42},
{{6577,1711}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 7, 137},
...
{{ 132,3027}, MAKE_STAR (SUPER_GIANT_STAR, BLUE_BODY, -1), MELNORME8_DEFINED, 1, 30},
{{1381,3066}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 5, 27},
{{2115,3099}, MAKE_STAR (DWARF_STAR, WHITE_BODY, -1), 0, 0, 133},
...
{{2538,3619}, MAKE_STAR (GIANT_STAR, BLUE_BODY, -1), 0, 2, 37},
...
{{3710,4359}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 2, 112},
...
{{6828,4781}, MAKE_STAR (DWARF_STAR, WHITE_BODY, -1), 0, 3, 134},
{{7130,4790}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 1, 134},
{{ 396,4799}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 5, 113},
{{1738,4812}, MAKE_STAR (GIANT_STAR, WHITE_BODY, -1), 0, 0, 136},
...
{{6816,4970}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 2, 134},
{{6074,4989}, MAKE_STAR (DWARF_STAR, WHITE_BODY, -1), 0, 2, 119},
{{ 674,5055}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 6, 113},
{{1216,5057}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 5, 135},
...
{{4007,5248}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 3, 103},
{{1213,5295}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 1, 135},
{{7416,5303}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 3, 72},
{{1164,5307}, MAKE_STAR (GIANT_STAR, ORANGE_BODY, -1), 0, 2, 135},
{{  58,5311}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 5, 73},
{{ 569,5314}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 3, 73},
{{7312,5341}, MAKE_STAR (DWARF_STAR, WHITE_BODY, -1), 0, 4, 72},
{{1253,5342}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 3, 135},
{{7573,5434}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 2, 72},
{{7154,5444}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 5, 72},
...
{{1105,5575}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 4, 135},
...
{{9420,5664}, MAKE_STAR (GIANT_STAR, ORANGE_BODY, -1), 0, 2, 130},
{{5479,5686}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 1, 138},
...
{{9510,5758}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 1, 130},
...
{{9645,5791}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 4, 130},
{{5316,5817}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 2, 138},
...
{{9388,5863}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 3, 130},
...
{{5437,5916}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 3, 138},
{{9564,5930}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 5, 130},
...
{{6559,6993}, MAKE_STAR (SUPER_GIANT_STAR, RED_BODY, -1), MELNORME1_DEFINED, 1, 80},
{{1508,6994}, MAKE_STAR (GIANT_STAR, ORANGE_BODY, -1), 0, 2, 26},
{{6895,7041}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 2, 93},
{{1830,7060}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 1, 26},
...
{{3025,7480}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 6, 131},
...
{{3743,7623}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 3, 131},
...
{{4880,7698}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 1, 10},
{{3260,7724}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 5, 131},
...
{{3527,7768}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 2, 131},
...
{{4947,7805}, MAKE_STAR (GIANT_STAR, GREEN_BODY, -1), 0, 2, 10},
{{3418,7809}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 4, 131},
{{6666,7812}, MAKE_STAR (DWARF_STAR, YELLOW_BODY, -1), 0, 2, 94},
{{3755,7823}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 1, 24},
...
{{3845,7881}, MAKE_STAR (GIANT_STAR, RED_BODY, -1), 0, 2, 24},
{{7791,7895}, MAKE_STAR (DWARF_STAR, RED_BODY, -1), 0, 3, 96},
{{6048,7919}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 3, 85},
{{3487,7924}, MAKE_STAR (DWARF_STAR, GREEN_BODY, -1), 0, 1, 131},
...
{{8352,7940}, MAKE_STAR (SUPER_GIANT_STAR, WHITE_BODY, -1), MELNORME2_DEFINED, 0, 97},
...
{{3690,8065}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), 0, 7, 131},
{{ 340,8066}, MAKE_STAR (DWARF_STAR, WHITE_BODY, -1), 0, 1, 60},
{{7104,8083}, MAKE_STAR (DWARF_STAR, ORANGE_BODY, -1), ZOQ_SCOUT_DEFINED, 0, 118},
{{ 199,8140}, MAKE_STAR (SUPER_GIANT_STAR, WHITE_BODY, -1), 0, 2, 60},
...
{{3349,8362}, MAKE_STAR (SUPER_GIANT_STAR, YELLOW_BODY, -1), 0, 8, 131},
...
{{8654,8587}, MAKE_STAR (SUPER_GIANT_STAR, GREEN_BODY, -1), MELNORME3_DEFINED, 1, 86},
...
{{7354,9291}, MAKE_STAR (SUPER_GIANT_STAR, RED_BODY, -1), MELNORME4_DEFINED, 1, 106},
...
{{9125,9770}, MAKE_STAR (DWARF_STAR, BLUE_BODY, -1), 0, 0, 114},
...
{{4892,9870}, MAKE_STAR (GIANT_STAR, RED_BODY, -1), SYREEN_DEFINED, 1, 124},
