...
#define RACE_COMMUNICATION \
		...
		SLAVERACE_CONVERSATION,    /* SLAVERACE_SHIP */ \
...
#define RACE_SHIP_FOR_COMM \
	...
	SLAVERACE_SHIP,    /* SLAVERACE_CONVERSATION */ \
...
#define RACE_HYPER_SPEED \
		...
		LOG_TO_HYPER (40),  /* JMS: ANDROSYNTH_SHIP */ \
		LOG_TO_HYPER (40),  /* SLAVERACE_SHIP */ \
...
#define RACE_COLORS \
		...
		BUILD_COLOR (MAKE_RGB15 (0x2A, 0x2A, 0x2A), 0x3D),  /* YEHAT_SHIP */ \
		...
		BUILD_COLOR (MAKE_RGB15 (0x0F, 0x00, 0x00), 0x2D),  /* SLAVERACE_SHIP */ \
