...
#define RACE_HYPER_SPEED \
		...
		LOG_TO_HYPER (30),  /* JMS: CHENJESU_SHIP */ \
		LOG_TO_HYPER (42),  /* JMS: MMRNMHRM_SHIP */ \
		LOG_TO_HYPER (30),  /* JMS: SLYLANDRO_KOHRAH_SHIP */ \
